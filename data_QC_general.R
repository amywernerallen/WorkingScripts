...
#### DATA QUALITY CHECKS
####
#### To be used for looking into the quality of data tables
####
...
good_systolic = length(systolic[systolic$vitals_systolic < 200 & systolic$vitals_systolic > 60,])/dim(systolic)[1] 
...
good_diastolic = length(diastolic[diastolic$vitals_diastolic < 150 & diastolic$vitals_diastolic > 50,])/dim(diastolic)[1] 
